/* 
 * The Attributes of Tss and Ldt Descriptor.
 */
#define AR_TSS						    0x0089
#define AR_LDT							0x0082

/* 
 * The Descriptor Privilege Levels.
 */
#define DPL_0							0x00
#define DPL_3							0x60

/* 
 * The Request Privilege Levels.
 */
#define RPL_0							0x00
#define RPL_3							0x03

/* 
 * The Process number constants.
 */
#define TOTAL_PROCESS_NUM				1000
#define USER_PROCESS_NUM 				TOTAL_PROCESS_NUM-1

/* 
 * The base address of process table.
 */
#define PROCESS_TABLE_ADDRESS			0x31000

/* 
 * The Status of one particular process.
 */
...
/* 
 * The Process Manager data structure manages process, maintains
